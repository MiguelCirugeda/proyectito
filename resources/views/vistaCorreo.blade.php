        ...
        <div class="d-flex justify-content-center align-items-center" style="margin-top: 150px;">
            <form class="w-100" action="{{ route('verificarContra') }}" method="POST">
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <p class="display-5 mx-auto">Debe introducir su contraseña para acceder al correo</p>

                    <div class="input-group mb-3 w-50">
                        <svg class="input-group-text btn btn-info" width="50" height="50" fill="currentColor"
                    ...
                    <div class="input w-25">
                        <input class="btn btn-success" type="submit" value="Acceder"><br><br>
                    </div>
